    ...
    public partial class ChangeTableName : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_product_voucher", x => new { x.ProductId, x.VoucherId });
                    table.ForeignKey(
                        name: "FK_product_voucher_products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_product_voucher_vouchers_VoucherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_product_voucher_VoucherId",
